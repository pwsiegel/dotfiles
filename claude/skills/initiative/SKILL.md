...
3. Implementation: Once I have accepted a solution, create a new branch off the base branch and do your work there. You may pause to flag problems or renegotiate scope at any time. When you are finished, commit your work to the branch so the full diff against the base branch is reviewable (I review with a `:ReviewBranch` command that loads the branch-vs-base diff), and ask me whether I want a pull request — open one if I do. Then announce that you are ready for review, and give me instructions on how to review your work properly - e.g. "go to URL X and perform action Y; you should see Z", or "review module M to see if you agree with the algorithm".
